...
public class spawnEnemies : MonoBehaviour {
	...
	void Start () {
        ...
        //enemy1 = Instantiate(enemy, new Vector3(-7, 1f, 14), Quaternion.Euler(new Vector3(0, 270, 0))) as GameObject;
        //enemy1Script = enemy1.GetComponent<EnemyAI>();
        //enemy1Script.patrolDistance = 17f;

        //enemy2 = Instantiate(enemy, new Vector3(-9, 1f, -9.5f), Quaternion.Euler(new Vector3(0, 270, 0))) as GameObject;
        //enemy2Script = enemy2.GetComponent<EnemyAI>();
        //enemy2Script.patrolDistance = 27f;

        //enemy3 = Instantiate(enemy, new Vector3(-36, 1f, -19), Quaternion.Euler(new Vector3(0, 90, 0))) as GameObject;
        //enemy3Script = enemy3.GetComponent<EnemyAI>();
        //enemy3Script.patrolDistance = 27f;

        //enemy4 = Instantiate(enemy, new Vector3(8, 1f, -3), Quaternion.Euler(new Vector3(0, 270, 0))) as GameObject;
        //enemy4Script = enemy4.GetComponent<EnemyAI>();
        //enemy4Script.patrolDistance = 12f;

        //enemy5 = Instantiate(enemy, new Vector3(33, 1f, 18), Quaternion.Euler(new Vector3(0, 180, 0))) as GameObject;
        //enemy5Script = enemy5.GetComponent<EnemyAI>();
        //enemy5Script.patrolDistance = 10f;

        //enemy6 = Instantiate(enemy, new Vector3(33, 1f, -9), Quaternion.Euler(new Vector3(0, 180, 0))) as GameObject;
